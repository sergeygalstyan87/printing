...
$(document).ready(() => {
    ...
    function initPhoneNumberFormat(context) {
        // Check if any input with name="phone" or name="custom_phone" exists within the provided context
        $(context).find("input[name='phone'], input[name='custom_phone']").each(function () {
            // Initialize intlTelInput for each input within the context (e.g., modal or page)
...
// Initialize for page load
    initPhoneNumberFormat("body");

    $('#registerModal').on('shown.bs.modal', function () {
        initPhoneNumberFormat(this);
    });
    ...
    $("#register_form").on('submit', (function (e) {
        ...
        // Validate each phone input within the modal
        $(this).find("input[name='phone'], input[name='custom_phone']").each(function () {
            var iti = window.intlTelInput(this);

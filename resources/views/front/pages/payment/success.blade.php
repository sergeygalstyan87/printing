                        ...
                        <div class="ec-checkout-inner">
                            ...
                            <div class="ec-checkout-wrap margin-bottom-30">
                                <div class="ec-checkout-block">
                                    <h3 style="text-align: center;color: green;margin-bottom: 0;">Success</h3>
                                    <p style="text-align: center;margin-top: 15px;">We received your purchase request, we'll be in touch shortly!</p>
                                </div>
                            </div>
                        </div>
                    </div>

                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="ec-vendor-block-profile">
                                        <h5>Addresses</h5>
                                        <form action="{{ route('profile.update_address', ['id' => $item->id]) }}" method="post" id="update_profile_form">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="{{ $item->phone }}" id="phone" required>
                                                ...
                                                <div class="col-md-8 mt-3">
                                                    ...
                                                    <input type="text" name="address" id="address" class="form-control" autocomplete="false" value="{{ $item->address }}" required>
                                                </div>
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    ...
                                                    <input type="text" name="zip" class="form-control" value="{{ $item->zip }}" required>
                                                </div>

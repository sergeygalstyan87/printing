                                                ...
                                                <td style="font-size:12px">
                                                    <div>
                                                        <div>
                                                            ...
                                                            <p><label>Order Confirmation #<span style="font-weight:bold">{{$order->est_number}}</span>. </label></p>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td style="font-weight:bold;color:#5b656d;padding-bottom:6px">
                                                                ...
                                                                <div></div>
                                                                <div style="border-top:1px solid #dfdfdf;padding-top:5px;margin-top:5px;word-break:break-word"><a href="mailto:{{$order->email}}" target="_blank">{{$order->email}}</a></div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td>
                                                    <table style="width:100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="text-align:right;white-space:nowrap;width:35%;border:1px solid #dfdfdf" bgcolor="#F5F5F5">Local Delivery</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr>
